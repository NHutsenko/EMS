...
namespace EMS.Core.API.Tests.Services
{
    ...
    public class DayOffsServiceTests: BaseUnitTest<DayOffsService>
    {
        ...
        public void GetByPersonId_should_handle_exception()
        {
            ...
            DayOffsResponse expectedResponse = new()
			{
				Status = new BaseResponse { Code = Code.UnknownError, ErrorMessage = "An error occured while loading day offs data" }
			};
        ...
        public void GetByPersionIdAndDateRange_should_return_all_day_offs_by_specified_person()
        {
            ...
            ByPersonIdAndDateRangeRequest request = new()
			{
				...
				Range = new ByDateRangeRequest { From = Timestamp.FromDateTime(new DateTime(2020, 12, 15, 0, 0, 0, DateTimeKind.Utc)), To = Timestamp.FromDateTime(new DateTime(2021, 1, 15, 0, 0, 0, DateTimeKind.Utc)) }
			};
